...
func Setup(db *gorm.DB, cfg *config.Config, svc *Services) *gin.Engine {
	...
	protected.Use(middleware.Auth(db, authService))
	{
		...
		protected.GET("/community/spaces/:id/threads", communityHandler.ListThreads)
		protected.GET("/community/threads/:threadId", communityHandler.GetThread)
		protected.POST("/community/spaces/:id/threads", communityHandler.StudentCreateThread)
		protected.POST("/community/threads/:threadId/replies", communityHandler.StudentCreateReply)
		protected.POST("/community/reactions", communityHandler.StudentToggleReaction)
